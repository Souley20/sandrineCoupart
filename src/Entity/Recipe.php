...
class Recipe
{
    ...
    private ?\DateTimeInterface $breakTim = null;
    ...
    public function getBreakTim(): ?\DateTimeInterface
    {
        return $this->breakTim;
    }

    public function setBreakTim(?\DateTimeInterface $breakTim): static
    {
